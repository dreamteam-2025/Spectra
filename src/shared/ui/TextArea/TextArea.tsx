...
export const TextArea = ({ label, id, error, wrapperClassName, className, disabled = false, ...rest }: Props) => {
  ...
  return (
    <div className={`${s.wrapper} ${wrapperClassName}`}>
      ...
      <textarea id={textareaId} className={textAreaClasses} disabled={disabled} {...rest} />
